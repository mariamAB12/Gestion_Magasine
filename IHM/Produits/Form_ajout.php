        ...
        <main role="main" class="col-md-9 ml-sm-auto col-lg-10 px-4">
            ...
            <div class="table-responsive">
                <form action="../../Gestion_Actions/Produits.php?action=Add" method="post" enctype="multipart/form-data">
                    <input type="hidden" value="<?=$idv?>" name="id_Vendeur">
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Nom</label>
                        <input name="nom" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Nom">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Marque</label>
                        <input name="marque" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Marque">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Categorie</label>
                        <input name="categorie" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Categorie">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Prix</label>
                        <input name="prix" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Prix">
                    </div>
                    <div class="mb-3">
                        <label for="exampleFormControlInput1" class="form-label">Quantite</label>
                        <input name="quantite" type="text" class="form-control" id="exampleFormControlInput1" placeholder="Quantite">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select name="pourcentageReduction" class="form-select form-select-lg mb-3" aria-label="Default select example">
                            <option value="0">Add Promotion</option>
                    ...
                    <div class="mb-3">
                        <input  type="submit" class="btn btn-primary" id="exampleFormControlInput1" value="Ajouter">
                    </div>
                </form>
            </div>
        </main>
