        ...
        <nav class="col-md-2 d-none d-md-block bg-light sidebar">
            <div class="sidebar-sticky">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link active" href="Commandslist.php">
                ...
                <table class="table table-striped table-sm">
                    ...
                    <?php foreach ($Commandes as $commande){?>
                        <tr>
                            ...
                            <td><?= $commande[4] ?></td>
                            <td colspan="2">
                                <a class="btn btn-warning btn-sm" href="../../Gestion_Actions/Commandes.php?action=Details&id=<?= $commande[0] ?>">Details</a>
                                <a class="btn btn-danger btn-sm" href="../../Gestion_Actions/Commandes.php?action=Confirme&id=<?= $commande[0] ?>">Confirme</a>
                                <a class="btn btn-danger btn-sm" href="../../Gestion_Actions/Commandes.php?action=Annuler&id=<?= $commande[0] ?>">Annuler</a>
                            </td>
                        </tr>
                    <?php }?>
                    </tbody>
